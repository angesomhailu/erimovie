...
import PinContainer from "@/components/manage-accounts/pin-container";
...
export default function ManageAccounts() {
  const {
    ...
    pageLoader,
    setPageLoader,
    setLoggedInAccount, // <-- FIX: include this from context
        ...
        <ul className="flex p-0 my-[25px]">
          ...
          {accounts && accounts.length < 4 ? (
            <li
              ...
              className=" text-black bg-[#10e509]   border-black max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] w-[155px] h-[155px] cursor-pointer flex justify-center items-center"
            >
              Add Account
            </li>
          ) : null}
